...
- **Problem:** Failed to connect via VS Code using the container name as the database. SQL Server requires a valid database for the initial login (such as `master`). The Docker container name is not automatically the name of an internal database.
